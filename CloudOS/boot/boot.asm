...
;字符串
;----------------------------------------------------------------------------
LoaderFileName		db	"LOADER  ELF", 0	; LOADER.BIN 之文件名
; 为简化代码, 下面每个字符串的长度均为 MessageLength
MessageLength		equ	16
BootMessage:		db	"Checking loader"; 9字节, 不够则用空格补齐. 序号 0
Message1		db	"OK                 "; 9字节, 不够则用空格补齐. 序号 1
Message2		db	"No                 "; 9字节, 不够则用空格补齐. 序号 2
;============================================================================
